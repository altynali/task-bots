...
export default function Hero() {
  return (
    <div className='mt-10 mb-20' id='advantages'>
            ...
            <main className='mt-8 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
              <div className='sm:text-center lg:text-center '>
                <h1 className='text-4xl tracking-tight font-extrabold text-indigo-400 sm:text-4xl md:text-5xl'>
                  <span className='block xl:inline'>Наши преимущества</span>
                </h1>
      ...
      <div className='px-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 gap-5 text-white'>
        <Card
          title='Скорость'
          desc='Быстрое исполнение полученных заказов.'
          id='1'
        />
        <Card
          title='Гарантия высокого качества'
          desc='Качественное исполнение. Аккаунты с аватарками и публикациями.'
          id='2'
        />
        <Card
          title='Надёжность технологий сервиса'
          desc='Мы гарантируем каждому клиенту надёжность нашего сервиса.'
          id='3'
        />
      </div>
    </div>
